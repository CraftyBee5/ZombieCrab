function capt = getCapt (captSize, xCapt, yCapt, thetaCapt)
  ...
  %captains weapon
  captPt25 = [ -1.25*captSize; -0.35*captSize; 1]; % base of weapon
  captPt26 = [ -1.25*captSize; -0.5*captSize; 1]; % base of weapon
  captPt27 = [ 1.25*captSize; -0.5*captSize; 1]; % top of weapon
